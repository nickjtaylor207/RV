...
# tenors = ['1W', '2W']
# days_back = 5
# df1, df2 = create_combined_summary(currency_list, tenors, days_back)
...
def create_fx_volatility_heatmap(currency_list, tenors, days_back):
    ...
    fig.suptitle(
        "Detailed Gamma Monitor - Implied Vol (IV), Implied Vol - realized Vol (I-R), Relative Value Rank to Market (mrkt_rel)", 
        fontsize=16, 
